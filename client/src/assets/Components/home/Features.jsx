...
const Features = () => {
  ...
  return (
   <>
<div id='features' className="flex flex-col item-center my-10 scroll-m-12">

<div className="flex justify-center">
  <div className="inline-flex items-center gap-2 text-sm text-green-600 bg-green-100 px-5 py-1.5 rounded-full">
...
<Title title ='Build your resume' description='Our streamlined process helps you create a professional resume in minutes with intelligent AI-powered tools and features.' />
            <div className="flex flex-col md:flex-row items-center justify-center xl:-10">
